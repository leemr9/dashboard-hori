        ...
        () => [
            ...
            },
            {
                ...
                Cell: ({ value }) => (
                    <Box display="flex" alignItems="center">
                        {value === 'Approved' && <FontAwesomeIcon icon={faCircleCheck} color="green" />}
                        {value === 'Disable' && <FontAwesomeIcon icon={faCircleXmark} color="red" />}
                        {value === 'Error' && <FontAwesomeIcon icon={faCircleExclamation} color="orange" />}
            ...
            },
            {
                ...
                Cell: ({ value }) => {
                    ...
                    const progressValue = parseInt(value, 0) // '70%'에서 70으로 변환
                    return <Progress value={progressValue} colorScheme="#422AFB;" size="sm" w={'108px'} />
                },
            },
        ],
        []
